...
public class Study {
    public static void main(String args[]) {
        ...
        // getメソッドではあくまで指定された値の取得しかできないので、常に「月の数字+任意の数値」の値を返してくる。
        //例えば11(=12月）から2ヶ月進めた先は現実世界では2月だが、getメソッドで+2をすると値は13になってしまう。
        //よって、繰り上げ・下げの処理を行いたい場合は値の加算・減産ができるメソッドを使う必要がある。
